...
from CMGTools.VVResonances.plotting.categories_VV_2016_jj import *
...
from CMGTools.VVResonances.plotting.Samples_2016_jj import createSampleLists
...
# -> Command line
analysis_dir = '/eos/cms/store/cmst3/group/exovv/VVtuple/VV3Dproduction/'
if socket.gethostname().find("uzhcms1") >= 0:
    analysis_dir = '/data/clange/ntuples/VV3D_2016/'
...
for cut_name in cuts:
    ...
    for variable in variables:
        ...
        plot.Group('WJets', ['WJetsToQQ_HT600toInf'])
        plot.Group('ZJets', ['ZJetsToQQ_HT600toInf'])
        ...
        plot.Group('data_obs', ['data_JetHT'])
        HistDrawer.draw(plot, plot_dir='plots_jj_2016/'+cut_name, channel=channel)
